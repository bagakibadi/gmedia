    ...
    >
      <div class="section">
        ...
        <div class="card-shadow" v-if="!dataTugas">
          <div class="p-3">
            <Loader text="Sedang memuat data tugas tiap mahasiswa." />
          </div>
        </div>
        <div v-else>
                        ...
                        <div class="mt-1">
                          ...
                          <div>
                            <a
                              ...
                              >Download
                              {{ soalUpload.data_jawaban.nama_file }}</a
                            >
                          </div>
                        </div>
                      </div>
...
export default {
      ...
      if (validation == 0) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            axios
              .post(
                this.url + "tugas/pemandu/tugas/penilaian",
                {
                  nim: data.nim,
                  tugas_id: this.$route.params.id,
  ...
  mounted() {
    ...
    axios
      .get(
        this.url + "tugas/pemandu/tugas/pengerjaan/" + this.$route.params.id,
        {
          headers: {
            Authorization: localStorage.token,
          },

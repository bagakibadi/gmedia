            ...
            <div class="table-responsive" v-else>
              <table class="table">
                ...
                <tbody v-if="dataMahasiswa">
                  <tr
                    class="align-middle"
                    v-for="(items, index) in dataMahasiswa"
                    :key="index"
                  >
                    <td>
                      <div>
      ...
      <div class="modal-dialog" style="max-width: 750px;">
        ...
        >
          ...
          <div class="modal-body modal-tambah">
            ...
            <hr />
            <Loader
              text="Sedang memuat detail mahasiswa."
            ...
            <form action="" v-if="editMahasiswaData">
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <label for="nim"
                      >NIM <span class="text-info">*</span></label
                    >
                    <div class="check-error">
                      <input
                        readonly
    ...
    tambahMahasiswa() {
      ...
      if (!this.tambah.nomor) {
        ...
        this.validationTambah.nomor.message =
          "Nomor Telepon Mahasiswa harus diisi!";
      } else {
      ...
      if (!this.tambah.tgllahir) {
        ...
        this.validationTambah.tgllahir.message =
          "Tanggal Lahir Mahasiswa harus diisi!";
      } else {
      ...
      if (!this.tambah.fakultas || this.tambah.fakultas === "") {
        ...
        this.validationTambah.fakultas_id.message =
          "Fakultas Mahasiswa harus dipilih!";
      } else {

							...
							<form action="" v-if="dataOnePemandu">
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="form-group">
											<label for="gugus">Gugus</label>
											<select name="gugus" disabled id="gugus" v-model="dataOnePemandu.gugus_id" class="form-control">
												<option value="" selected disabled>Pilih Gugus</option>
												<option :value="items.uuid" v-for="(items,index) in dataGugus" :key="index">{{items.name}}</option>
											</select>
										</div>
		...
		<div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
							...
							<form action="">
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="form-group">
											<label for="gugus">Gugus</label>
											<select name="gugus" id="gugus" v-model="tambah.gugus_id" class="form-control">
												<option value="" selected disabled>Pilih Gugus</option>
												<option :value="items.uuid" v-for="(items,index) in dataGugus" :key="index">{{items.name}}</option>
											</select>
										</div>
					...
					<div class="modal-footer">
						<button type="button" @click="tambahPemandu" class="btn btn-primary">Tambah</button>
						<a type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</a>
					</div>
				</div>
			</div>

      ...
      <div class="section">
        <div class="card-shadow mb-3">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
              <div class="title-content">Data Prodi</div>
              <div class="d-flex">
...
export default {
	...
	methods: {
      ...
      reader.readAsDataURL(asd);
		...
		editData() {
			if(this.dataOneProdi.nama && this.dataOneProdi.fakultas_id) {
				setTimeout(() => {
					axios.put(`https://gmedia.primakom.co.id/gmedia/superadmin/prodi/${this.dataOneProdi.uuid}`, this.dataOneProdi, {
						headers: {
							Authorization: localStorage.token
						}
					}).then((result) => {
			...
			if(!this.dataOneProdi.nama) {
				...
				this.validationEdit.nama.message = 'Nama Prodi harus diisi!'
			} else {
        ...
        $(".dropify").dropify({
          messages: {
			...
			axios.get(`https://gmedia.primakom.co.id/gmedia/superadmin/prodi/${uuid}`, {
				headers: {
					Authorization: localStorage.token
				}
			}).then((result) => {
        ...
        confirmButtonText: 'Yes, delete it!'
				...
				if(result.isConfirmed) {
					axios.delete(`https://gmedia.primakom.co.id/gmedia/superadmin/prodi/${uuid}`,{
						headers: {
							Authorization: localStorage.token
						}
					}).then((res) => {
      ...
      reader.readAsDataURL(asd);
        ...
        axios.post('https://gmedia.primakom.co.id/gmedia/superadmin/prodi', this.tambah, {
          headers: {
            Authorization: localStorage.token
          }
        }).then((result) => {
          ...
          console.log(err)
			...
			if(!this.tambah.nama) {
				...
				this.validationTambah.nama.message = 'Nama Prodi harus diisi!'
			} else {
			...
			if(!this.tambah.fakultas_id) {
				...
				this.validationTambah.fakultas_id.message = 'Fakultas harus di pilih!'
			} else {

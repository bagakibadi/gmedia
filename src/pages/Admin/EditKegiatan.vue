        ...
        <div class="card-shadow mb-3">
					<div class="padding-kegiatan">
							...
							<div class="row tambahjadwal">
								...
								<div class="col-lg-3">
									<div class="form-group">
										...
										<input type="text" v-model="dataOneKegiatan.data.deskripsi" placeholder="Deskripsi" name="deskripsi" id="deskripsi" class="form-control">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="form-group">
						...
						<div class="jadwal-baru">
							...
							<div v-if="dataOneKegiatan.data.aktivitas.length !== null">
									...
									<div class="row tambahjadwal">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="datetime-local" v-model="dataOneKegiatan.data.aktivitas[index].start_time" id="start_date" class="form-control">
											</div>
										</div>
										<div class="col-lg-3">
											<div class="form-group">
												<label for="end_date">End Time</label>
												<input type="datetime-local" v-model="dataOneKegiatan.data.aktivitas[index].end_time" name="end_date" id="end_date" class="form-control">
											</div>
										</div>
										<div class="col-lg-3">
											<div class="form-group">
												<label for="tipe">Tipe Aktivitas</label>
												<select v-if="dataTipe" class="form-select" name="tipe" required id="tipe" v-model="dataOneKegiatan.data.aktivitas[index].tipe">
...
export default {
	...
	methods: {
		...
		addfields() {
			this.dataOneKegiatan.data.aktivitas.push({ nama: '', start_time: '', end_time: '' })
		},
		upload(asd) {

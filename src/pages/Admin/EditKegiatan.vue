        ...
        <div class="card-shadow mb-3">
					<div class="padding-kegiatan">
						...
						<div class="jadwal-baru">
							...
							<div class="row tambahjadwal" v-if="dataOneKegiatan">
								<div class="col-lg-4">
									<div class="form-group">
										<label for="topik">Topik</label>
										<div class="check-error">
											<input type="text" v-model="dataOneKegiatan.data.topik" name="topik" id="topik" placeholder="PKK-BN 2021 Sesi 1" class="form-control">
								...
								<div class="col-lg-4">
									<div class="form-group">
										...
										<div class="check-error">
											<input type="date" v-model="dataOneKegiatan.data.start_date" name="start_date" id="start_date" class="form-control">
								...
								<!-- <div class="col-lg-3">
									<div class="form-group">
										...
										<div class="check-error">
											<input type="date" v-model="dataOneKegiatan.data.end_date" name="end_date" id="end_date" class="form-control">
								...
								<div class="col-lg-4">
									<div class="form-group">
										...
										<div class="check-error">
											<select v-if="dataGugus" name="gugus" id="gugus" class="form-select" v-model="dataOneKegiatan.data.gugus_id">
								...
								<div class="col-lg-4">
									<div class="form-group">
										...
										<div class="check-error">
											<textarea name="deskripsi" id="deskripsi" class="form-control" v-model="dataOneKegiatan.data.deskripsi" placeholder="Deskripsi" style="height: 65px" cols="30" rows="10"></textarea>
						...
						<div class="jadwal-baru">
							...
							<div v-if="dataOneKegiatan">
								<div v-for="(items,index) in dataOneKegiatan.data.aktivitas" :key="index.id">
										...
										<div class="row tambahjadwal">
											...
											<div class="col-lg-3">
												<div class="form-group">
													...
													<div class="check-error">
														<input type="time" v-model="dataOneKegiatan.data.aktivitas[index].start_time" id="start_date" class="form-control">
											...
											<div class="col-lg-3">
												<div class="form-group">
													...
													<div class="check-error">
														<input type="time" v-model="dataOneKegiatan.data.aktivitas[index].end_time" name="end_time" id="end_time" class="form-control">
											...
											<div class="col-lg-3">
												<div class="form-group">
													...
													<div class="check-error">
														<select v-if="dataTipe" class="form-select" name="tipe" id="tipe" v-model="dataOneKegiatan.data.aktivitas[index].tipe">
											...
											<div class="col-lg-6">
												<div class="form-group">
													<label for="deskripsi">Deskripsi</label>
													<div class="check-error">
														<input type="text" v-model="dataOneKegiatan.data.aktivitas[index].deskripsi" placeholder="Deskripsi" name="deskripsi" id="deskripsi" class="form-control">
											...
											<div class="col-lg-3">
												<div class="form-group h-75">
													<div class="d-flex h-100 align-items-end">
														<div @click="deleteArray(index)" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</div>
													</div>
												</div>
											</div>
										</div>
	...
	methods: {
		...
		getKegiatan() {
			axios.get(`https://gmedia.primakom.co.id/gmedia/superadmin/kegiatanaktivitas/${this.$route.params.id}`, {
				...
				this.dataOneKegiatan = result.data
				console.log(result.data.data.aktivitas.length)
				for(let i = 0; i < result.data.data.aktivitas.length;i++) {
					// console.log(i)
					this.aktivitas.push({
						nama: {
							status: true,
		...
		addfields() {
			this.dataOneKegiatan.data.aktivitas.push({ nama: '', start_time: '', end_time: '',tipe: '', aktivitas_uuid: '', deskripsi: '', })
      ...
      reader.onload = (e) => {
        ...
        var ee = e.target.result
				this.dataOneKegiatan.data.lampiran = ee.replace("data:image/jpeg;base64,", "")
      };
      ...
      reader.readAsDataURL(asd);
        ...
        this.dataOneKegiatan.data.lampiran = null
			...
			let aktivitas = this.dataOneKegiatan.data.aktivitas
			let count = 0
			...
			if (!this.dataOneKegiatan.data.topik) {
        ...
        this.validationTambah.topik.message = null;
			...
			if (!this.dataOneKegiatan.data.deskripsi) {
        ...
        this.validationTambah.deskripsi.message = null;
			...
			if (!this.dataOneKegiatan.data.lampiran) {
        ...
        this.validationTambah.lampiran.message = null;
			...
			if (!this.dataOneKegiatan.data.gugus_id) {
        ...
        this.validationTambah.gugus_id.message = null;
			...
			if (!this.dataOneKegiatan.data.start_date) {
